...
public class Homework {
     ...
     */
        ...
        public static String setStoreName() {
        ...
        public static void greetCustomer() {
            ...
            String greeting = greetCustomer();
            System.out.println(greeting);
        }

        // 3) Complete the getSalePrice() method below and make sure the correct value is printed here

        public static void getSalePrice(Double originalPrice, Double discount) {
            Double originalPrice = 79.99;
            Double discount = 0.25; // a 25% discount

            Double salePrice = originalPrice - (originalPrice * discount); //I know this is how the formula should
            //work to get the answer, but I'm not sure how to turn that into a function
        ...
        public static void getClearancePrice(double originalPrice, double discount) {
        ...
        public static void getBulkDiscount() {
